...
public class UserController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("pricing", "disabled");
        model.addAttribute("features", "disabled");
        model.addAttribute("about", "disabled");
        model.addAttribute("support", "disabled");
        return "general/index";
    }

    @GetMapping("/pricing")
    public String pricing(Model model) {
        model.addAttribute("home", "disabled");
